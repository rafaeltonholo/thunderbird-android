package net.thunderbird.feature.notification.ui.builder

import net.thunderbird.feature.notification.ui.NotificationStyle
import net.thunderbird.feature.notification.ui.NotificationStyle.System.BigTextStyle
import net.thunderbird.feature.notification.ui.NotificationStyle.System.InboxStyle
...
class SystemNotificationStyleBuilder internal constructor() {
    ...
    /**
     * Sets the style of the notification to [NotificationStyle.System.BigTextStyle].
     *
    ...
    /**
     * Sets the style of the notification to [NotificationStyle.System.InboxStyle].
     *
    ...
    /**
     * Builds and returns the configured [NotificationStyle.System].
     *
     ...
     *
     * @return The configured [NotificationStyle.System] which will be either a [BigTextStyle] or an [InboxStyle].
     * @throws IllegalStateException if both `bigText` and `inboxStyle` are set, or if neither are set.
     */
    fun build(): NotificationStyle.System {
