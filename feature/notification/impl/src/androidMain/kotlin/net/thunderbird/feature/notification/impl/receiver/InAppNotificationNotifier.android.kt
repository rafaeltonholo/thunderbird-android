...
internal class AndroidInAppNotificationNotifier(
    ...
    override fun show(id: NotificationId, notification: InAppNotification) {
        ...
        context.sendOrderedBroadcast(
            /* intent = */ intent,
            /* receiverPermission = */ POST_IN_APP_NOTIFICATION_PERMISSION,
        )
    }
    ...
    private fun startBroadcast() {
        ...
        ContextCompat.registerReceiver(
            ...
            /* filter = */ filter,
            /* broadcastPermission = */ POST_IN_APP_NOTIFICATION_PERMISSION,
            /* scheduler = */ null,
            /* flags = */ InAppNotificationBroadcastReceiver.FLAGS,
